    ...
    <section class="relative flex items-center justify-center overflow-hidden grid-pattern">
        ...
        <div class="relative max-w-5xl mx-auto px-4 sm:px-6 text-center pt-28 pb-12">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up delay-300">
                <a href="#/install" class="px-8 py-4 bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-500 hover:to-blue-500 text-white rounded-2xl shadow-2xl shadow-green-500/30 transition-all hover:scale-105 active:scale-95 font-bold text-base inline-flex items-center gap-2">
                    ⬇️ Install Extension
                </a>
                <a href="https://github.com/joecodecreations/antigravity_automation" class="px-8 py-4 glass hover:bg-slate-800/80 text-white rounded-2xl transition-all hover:scale-105 font-medium text-base border border-slate-700 hover:border-slate-600 inline-flex items-center gap-2">
    ...
    <section class="max-w-5xl mx-auto px-4 sm:px-6 mb-20">
        <div class="glass-strong rounded-3xl p-10 md:p-16 text-center relative overflow-hidden glow-indigo">
            ...
            <div class="relative">
                ...
                <a href="#/install" class="px-8 py-4 bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-500 hover:to-blue-500 text-white rounded-2xl shadow-2xl shadow-green-500/30 transition-all hover:scale-105 active:scale-95 font-bold text-base inline-block">Install the Extension</a>
            </div>
        </div>
    </section>
